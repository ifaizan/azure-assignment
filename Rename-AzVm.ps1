...
if ($oldvm.StorageProfile.osdisk.ostype.value -eq "Windows" -and $oldVM.StorageProfile.OsDisk.vhd -eq $null) {
...
elseif ($oldvm.StorageProfile.osdisk.ostype.value -eq "Linux" -and $oldVM.StorageProfile.OsDisk.vhd -eq $null) {
...
if ($oldvm.StorageProfile.osdisk.ostype.value -eq "Windows" -and $oldVM.StorageProfile.OsDisk.vhd -ne $null) {
...
elseif ($oldvm.StorageProfile.osdisk.ostype.value -eq "Linux" -and $oldVM.StorageProfile.OsDisk.vhd -ne $null) {
