locals {
  vnet_info = {
    "VNET-PROD-SWT-WESTEU-OMS" = {
      cidr                = ["10.0.0.0/22"]
      subnet_names        = ["SNET-PROD-SWT-WESTEU-OMS-FRONTEND", "SNET-PROD-SWT-WESTEU-OMS-BACKEND"],
    ...
    "VNET-PROD-SWT-WESTEU-CMS" = {
      cidr                = ["10.1.0.0/22"]
      subnet_names        = ["SNET-PROD-SWT-WESTEU-CMS-FRONTEND", "SNET-PROD-SWT-WESTEU-CMS-BACKEND"],
    ...
    "VNET-PROD-SWT-WESTEU-PIMS" = {
      cidr                = ["10.2.0.0/22"]
      subnet_names        = ["SNET-PROD-SWT-WESTEU-PIMS-FRONTEND", "SNET-PROD-SWT-WESTEU-PIMS-BACKEND"],
